...
In order to support loading of multiple wallets in charedcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is charedcoin.cpp.
...
Changes to charedcoin.cpp
----------------------
charedcoin.cpp is the entry point into charedcoin-qt, and as such, will require some minor modifications to provide hooks for
