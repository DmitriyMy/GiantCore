...
CHAREDCOIN now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<charedcoin_address\> \<monthly_payment_charedcoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ CHAREDCOIN, _12_ times over the course of a year totaling _24000_ CHAREDCOIN.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<charedcoin_address\> \<monthly_payment_charedcoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` charedcoin.
 ...
 * vote-many          - Vote on a charedcoin initiative
 * vote-alias         - Vote on a CHAREDCOIN initiative
 * vote               - Vote on a CHAREDCOIN initiative/budget
