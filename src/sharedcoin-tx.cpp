...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CHAREDCOIN Core charedcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  charedcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded charedcoin transaction") + "\n" +
                               "  charedcoin-tx [options] -create [commands]   " + _("Create hex-encoded charedcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded charedcoin transaction
