...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CHAREDCOIN server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CHAREDCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CHAREDCOIN features */
        {"charedcoin", "masternode", &masternode, true, true, false},
        {"charedcoin", "masternodelist", &masternodelist, true, true, false},
        {"charedcoin", "mnbudget", &mnbudget, true, true, false},
        {"charedcoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"charedcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"charedcoin", "mnsync", &mnsync, true, true, false},
        {"charedcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"charedcoin", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use charedcoind, or the -server option to charedcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> charedcoin-cli " + methodname + " " + args + "\n";
}
