                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CHAREDCOIN-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CHAREDCOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and charedcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CHAREDCOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about CHAREDCOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CHAREDCOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CHAREDCOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CHAREDCOIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a CHAREDCOIN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CHAREDCOIN Core help message to get a list with possible CHAREDCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CHAREDCOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CHAREDCOIN network", "", count));
}
...
{
    QString strTitle = tr("CHAREDCOIN Core"); // default title
