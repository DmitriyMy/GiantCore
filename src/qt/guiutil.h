...
/** Utility functions used by the CHAREDCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render CHAREDCOIN addresses in monospace font
...
// Parse "charedcoin:" URI into recipient object, return true on successful parsing
